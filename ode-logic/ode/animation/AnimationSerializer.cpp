...
AnimationSerializer::Error::operator AnimationSerializer::ErrorType() const {
    return type;
}
...
const char *AnimationSerializer::Error::typeString() const {
    switch (type) {
        case ErrorType::OK:
            return "OK";
        case ErrorType::UNREPRESENTABLE_FLOAT_VALUE:
...
AnimationSerializer::Error AnimationSerializer::serializeOdeLayerAnimationType(ode::LayerAnimation::Type const &value) {
    switch (value) {
        case ode::LayerAnimation::Type::TRANSFORM: write("\"TRANSFORM\""); break;
        case ode::LayerAnimation::Type::ROTATION: write("\"ROTATION\""); break;
        case ode::LayerAnimation::Type::OPACITY: write("\"OPACITY\""); break;
        case ode::LayerAnimation::Type::FILL_COLOR: write("\"FILL_COLOR\""); break;
        default:
            return Error(ErrorType::UNKNOWN_ENUM_VALUE, &value);
    }
    return ErrorType::OK;
}
...
AnimationSerializer::Error AnimationSerializer::serializeDouble(double const &value) {
    ...
    switch (buffer[1]) {
        ...
        case 'a':
            return Error(ErrorType::UNREPRESENTABLE_FLOAT_VALUE, &value);
            break;
        default:
            write(buffer);
    }
