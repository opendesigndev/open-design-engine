...
bool SimpleBlitShader::initialize(const DesignEditorShader::SharedVertexShader &sharedVertexShader) {
    return DesignEditorShader::initialize(sharedVertexShader, "diagnostics-blit-fs");
}
