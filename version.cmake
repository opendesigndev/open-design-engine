...
if(NOT DEFINED ODE_VERSION_NPM)
    execute_process(COMMAND git log -n 1 "--pretty=format:%h_%cs" WORKING_DIRECTORY "${CMAKE_SOURCE_DIR}" OUTPUT_VARIABLE ODE_VERSION_NPM OUTPUT_STRIP_TRAILING_WHITESPACE)
    string(REPLACE "-" "" ODE_VERSION_NPM ${ODE_VERSION_NPM})
