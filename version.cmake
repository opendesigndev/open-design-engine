...
if(NOT DEFINED ODE_BUILD_COMMIT_SHA)
    execute_process(COMMAND git describe --tags --always WORKING_DIRECTORY "${CMAKE_SOURCE_DIR}" OUTPUT_VARIABLE ODE_BUILD_COMMIT_SHA OUTPUT_STRIP_TRAILING_WHITESPACE)
endif()
if(NOT DEFINED ODE_VERSION_NPM)
    if(DEFINED ENV{ODE_VERSION_NPM})
        SET(ODE_VERSION_NPM $ENV{ODE_VERSION_NPM})
    else()
        if(NOT DEFINED ODE_BUILD_COMMIT_WITH_DATE)
            execute_process(COMMAND git log -n 1 "--pretty=format:%h_%cs" WORKING_DIRECTORY "${CMAKE_SOURCE_DIR}" OUTPUT_VARIABLE ODE_BUILD_COMMIT_WITH_DATE OUTPUT_STRIP_TRAILING_WHITESPACE)
        endif()
        string(REPLACE "-" "" ODE_VERSION_NPM ${ODE_BUILD_COMMIT_WITH_DATE})
        string(REPLACE "_" "-" ODE_VERSION_NPM ${ODE_VERSION_NPM})
        string(PREPEND ODE_VERSION_NPM ${ODE_VERSION}-)
    endif()
endif()
