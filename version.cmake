...
if(NOT DEFINED ODE_VERSION_NPM)
    if(NOT DEFINED ODE_THIS_COMMIT)
        execute_process(COMMAND git log -n 1 "--pretty=format:%h_%cs" WORKING_DIRECTORY "${CMAKE_SOURCE_DIR}" OUTPUT_VARIABLE ODE_THIS_COMMIT OUTPUT_STRIP_TRAILING_WHITESPACE)
    endif()
    string(REPLACE "-" "" ODE_VERSION_NPM ${ODE_THIS_COMMIT})
