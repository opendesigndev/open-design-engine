...
if(NOT DEFINED ODE_BUILD_COMMIT_TAG)
    execute_process(COMMAND git describe --tags WORKING_DIRECTORY "${CMAKE_SOURCE_DIR}" RESULT_VARIABLE ODE_TMP_NON_TAG OUTPUT_VARIABLE ODE_BUILD_COMMIT_TAG OUTPUT_STRIP_TRAILING_WHITESPACE ERROR_QUIET)
...
if(NOT DEFINED ODE_NPM_VERSION)
    if(DEFINED ENV{ODE_NPM_VERSION})
        ...
        if("${ODE_BUILD_COMMIT_TAG}" STREQUAL "v${ODE_VERSION}")
            set(ODE_NPM_VERSION "${ODE_VERSION}")
        else()
