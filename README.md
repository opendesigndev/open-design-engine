...
- The version of ODE is defined in [vcpkg.json](vcpkg.json) and automatically parsed from this file during CMake generation.
- When changing the vcpkg dependency set or their versions (e.g. vcpkg baseline), you should increment `ODE_DEPENDENCY_SET_VERSION` in [.gitlab-ci.yml](.gitlab-ci.yml), otherwise
